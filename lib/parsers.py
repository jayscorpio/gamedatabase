...
def artifact_parser(filename,data,get_translation_specific):
    ...
    if data["assets.icon"]:
        data["assets.icon"] = lib.utils.mount_assets("item_arti/",data["assets.icon"],"png")
    if data["assets.image"]:
        data["assets.image"] = lib.utils.mount_assets("item_arti/",data["assets.image"],"png")
    if data["assets.thumbnail"]:
        data["assets.thumbnail"] = lib.utils.mount_assets("item_arti/",data["assets.thumbnail"],"jpg")
    return data
...
def materials_parser(filename,data,get_translation_specific):
    ...
    if data["assets.icon"]:
        data["assets.icon"] = lib.utils.mount_assets("item/",data["assets.icon"],"png")
    return data
...
def hero_parser(filename,data,get_translation_specific):
    ...
    if data["specialty"]:
        ...
        data["specialty.assets.icon"] = lib.utils.mount_assets("skill/",data["specialty.icon"],"png")
    ...
    for sk_in in range(len(data["skills"])):
        ...
        data["skills"][sk_in]["assets"]["icon"] = lib.utils.mount_assets("skill/",data["skills"][sk_in]["icon"],"png")

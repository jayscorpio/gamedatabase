...
parser.add_argument("-B", "--buildonly", help="build only, without attempting to create collections or call mongoimport", action="store_true")
parser.add_argument("-I", "--importonly", help="import only, build dist_py/_collections with current dist_py files and call mongoimport", action="store_true")
...
parser.add_argument("-v", "--verbose", help="verbose, will print all actions done", action="store_true")
